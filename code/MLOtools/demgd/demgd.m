...
surf(w1grid, w2grid,ygrid);
surf(w1grid, w2grid,ygrid,'FaceColor',[.9 .9 .9],'EdgeColor',[.5 .5 .5])
...
% display params
DROPSTEP = 0.03;    % vertical drop on ball from "sky" on each step
...
if z > zmax/2 & z <= zmax
    ...
    while true
        ...
        title(['Iterations: ' num2str(iteration) ', Error: ' num2str(z) ],'FontSize',20);
